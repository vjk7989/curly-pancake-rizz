...
const HomePage = () => {
    ...
    return (
        <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
            ...
            {/* hero */}
            <Wrapper>
                <div className="absolute inset-0 dark:bg-[linear-gradient(to_right,#471696_0.2px,transparent_1px),linear-gradient(to_bottom,#471696_0.2px,transparent_1px)] bg-[linear-gradient(to_right,#471696_1px,transparent_1px),linear-gradient(to_bottom,#471696_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)] -z-10 h-[150vh] opacity-10" />
                    ...
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        ...
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                                Streamline your business with our products
                            </h1>
                            <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                                Delivering the best insights for your business
                            </p>
                            <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                                <Link href="#" className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-8 shadow-3xl shadow-background/40 cursor-pointer select-none">
                                    <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                                        ✨ {"  "} Start improving your sales now!
                                    </p>
                                    ...
                                    {images.map((src, index) => (
                                        ...
                                        >
                                            <Image
                                                ...
                                                height={675}
                                                priority={index === 0}
                                                className="rounded-md lg:rounded-xl bg-foreground/10 shadow-2xl ring-1 ring-border w-full h-full object-contain"
                                            />
                                        </div>
                                    ))}
                                </div>
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                            Three steps to improve your sales
                        </h2>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            MNOCH offers a range of features to help you bring stunning results in no time
                        </p>
                    </div>
                </Container>
                <Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            See how WE empowers businesses of all sizes. Here&apos;s what real people are saying
                        </p>
                    </div>
                </Container>
                <Container>
                    ...
                    <LampContainer>
                        <div className="flex flex-col items-center justify-center relative w-full text-center">
                            <h2 className="text-4xl lg:text-5xl xl:text-6xl lg:!leading-snug font-semibold mt-8">
                                From Idea to REALITY <br /> Faster Than Ever
                            </h2>
                            <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                                Build stunning CRM/ERP with MNOCH intuitive products to get your business to the next level
                            </p>
